...
class Trades(models.Model):
    ...
    id_game_requester = models.ForeignKey(User_Game, blank = True, null = True, verbose_name = 'Jogo Requisitante', related_name = 'trades_games_requester')
    id_game_requested = models.ForeignKey(User_Game, blank = True, null = True, verbose_name = 'Jogo Requisitado', related_name = 'trades_games_requested')
    ...
    date = models.DateField('Data da Troca', blank = True, null = True)
